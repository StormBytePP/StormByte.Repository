...
export GCC_FORCED_PACKAGES="sys-devel/gcc sys-libs/glibc sys-libs/libxcrypt app-crypt/efitools net-print/hplip app-crypt/seahorse"
...
if [ "${EBUILD_PHASE}" == "configure" ] && list_contains "${GCC_FORCED_PACKAGES}" "${CATEGORY}/${PN}"; then
    CC="gcc"
    CXX="g++"
    ADDR2LINE="addr2line"
    AS="as"
