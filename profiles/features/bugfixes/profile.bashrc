...
local FORCE_LD_UNDEFINED_VERSION="dev-libs/totem-pl-parser media-libs/tremor net-analyzer/rrdtool net-firewall/nfacct net-fs/samba net-libs/gtk-vnc net-misc/spice-gtk net-wireless/bluez sys-libs/ldb sys-libs/slang sys-libs/talloc sys-libs/tevent sys-libs/tdb"
