...
local FORCE_BINUTIL_VARS="app-crypt/efitools dev-libs/jansson sys-boot/grub"
local FORCE_LD_UNDEFINED_VERSION="dev-java/openjdk dev-libs/totem-pl-parser media-libs/alsa-lib media-libs/libva media-libs/tremor net-analyzer/rrdtool net-firewall/nfacct net-libs/gtk-vnc net-misc/spice-gtk net-wireless/bluez x11-libs/wxGTK sys-libs/ldb sys-libs/libblockdev sys-libs/slang sys-apps/util-linux"
