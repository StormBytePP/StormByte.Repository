...
if [[ "${EBUILD_PHASE}" == "configure" ]] ; then
    local LTO_FORCED_PACKAGES="app-office/libreoffice dev-lang/erlang mail-client/thunderbird media-libs/x264 media-libs/x265 media-video/ffmpeg www-client/firefox"
