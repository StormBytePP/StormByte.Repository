...
SRC_URI="https://releases.llvm.org/${PV}/${MY_P}.tar.xz
	...
	polly? ( https://releases.llvm.org/${PV}/polly-${PV}.src.tar.xz )"
S=${WORKDIR}/${MY_P}
...
IUSE="debug doc exegesis gold libedit +libffi ncurses test xar xml z3 polly -lto
